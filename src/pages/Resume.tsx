      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground">
            <a href="mailto:illashashank@gmail.com" className="flex items-center gap-2 hover:text-primary transition-colors">
              <Mail className="w-4 h-4" />
              illashashank@gmail.com
            </a>
            <a href="https://linkedin.com/in/illashashank" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors">
              <Linkedin className="w-4 h-4" />
              LinkedIn
            </a>
            <a href="tel:9492932679" className="flex items-center gap-2 hover:text-primary transition-colors">
        ...
        <Card className="p-6 mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Dedicated Software Tester with 15 months of hands-on experience in automation and API testing, possessing a solid grasp of QA fundamentals, SDLC, and STLC. Strong team player with excellent communication and collaboration skills. Focused on delivering reliable, maintainable, and efficient test solutions. Quick to learn new tools and technologies to contribute to the success of QA team.
          </p>
        </Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  ...
                  <li>Performed initial Root Cause Analysis (RCA) on bugs using browser developer tools (Network and Console tabs) to identify and isolate issues.</li>
                  <li>Worked closely with developers and backend teams to resolve issues and ensure smooth release cycles.</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Wrote and executed a basic load testing script in Apache JMeter to evaluate API performance for Vodex's outbound calling system.</li>
                  <li>Simulated realistic workloads to identify response time delays and throughput limits.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <Card className="p-6 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              Understood and applied key testing principles and workflows through guided practical exercises and evaluations in my 3rd and 4th year of bachelor's degree.
            </p>
          </div>
        </Card>
